...
if (isset($_POST['addBtn'])) {
    $sql = "INSERT INTO food (foodName, foodCalories, foodCategory, foodImage, emailID) VALUES ('$_POST[foodName]', '$_POST[foodCalories]', '$_POST[foodCategory]', '$_POST[foodImage]', '$email')";
